...
public class StepDefinition {
	...
	public void user_clicks_on_view_on_the_map_button() throws Throwable {
		...
		Thread.sleep(20000);
		System.out.println(driver.findElement(By.cssSelector("image:nth-child(2)")).isDisplayed());
		/*List<WebElement> cranesList = driver.findElements(By.xpath("//*[@fill-opacity='0']"));
